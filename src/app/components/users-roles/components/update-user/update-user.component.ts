...
export class UpdateUserComponent {
  ...
  constructor(private readonly fb: FormBuilder) {
    ...
    this.updateUserForm = this.fb.group<IUpdateUserForm>({
      ...
      idUser: this.fb.control('CROD1234',
        {
  ...
  protected updatePermissionSecurity(permissionName: string): void {
    ...
    if (pem) {
      ...
      this.updateUserForm.get('permissionsSecurity')?.setValue(this.arrayUserSecurity);
      this.updateUserForm.get('permissionsSecurity')?.updateValueAndValidity();
  }
  ...
  protected updatePermission(permissionName: string): void {
    ...
    // Actualiza el control del formulario
    this.updateUserForm.get('permissions')?.setValue(this.arrayPermissions);
    this.updateUserForm.get('permissions')?.updateValueAndValidity();
  }
